...
function seed_demo(PDO $pdo, $driver) {
    ...
    /* کاربران */
    $users = [
        ['مدیر پارچینو', '09125085832', 'admin@parche.local', 'admin123', 'admin', null],
    ...
    $settings = [
        'site_name' => 'پارچینو',
        'site_tagline' => 'فروشگاه اینترنتی جامع انواع پارچه — طبیعی، شیمیایی و مزون',
        'hero_title' => 'هر پارچه‌ای که تصور می‌کنید، اینجاست',
        'hero_subtitle' => 'خرید اینترنتی انواع پارچه با قیمت متر و موجودی لحظه‌ای؛ سفارش شما همان روز ثبت و به سراسر کشور ارسال می‌شود.',
        'phone' => '',
        'mobile' => '09125085832',
        'email' => '',
        'address' => 'فروشگاه اینترنتی پارچینو — ارسال به سراسر ایران',
        'instagram' => '',
        'telegram' => '',
        'whatsapp' => '09125085832',
        'shipping_flat' => '45000',
        'free_shipping_min' => '3000000',
        'about_text' => "پارچینو از سال ۱۴۰۵ فعالیت خود را به‌صورت کاملاً اینترنتی آغاز کرد تا خرید پارچه به‌ساده‌ترین شکل ممکن باشد؛ بدون نیاز به رفت‌وآمد، با قیمت شفاف به‌صورت متر و موجودی لحظه‌ای.\nما عرضه‌ی مستقیم انواع پارچه‌های طبیعی، شیمیایی و مزون را انجام می‌دهیم. تمام پارچه‌ها قبل از ارسال کنترل کیفیت می‌شوند و امکان مرجوعی تا ۷ روز برای مشتریان گرامی فراهم است.\nپشتیبانی پارچینو: 09125085832",
        'footer_note' => 'کلیه حقوق مادی و معنوی این وب‌سایت متعلق به پارچینو است.',
        'currency' => 'تومان',
    ...
    $stM->execute([1, 4, 'به پارچینو خوش آمدید', "سلام!\nحساب شما در پارچینو ایجاد شد. با اولین خرید می‌توانید از کد تخفیف WELCOME10 استفاده کنید.\nهر سوالی داشتید همین‌جا برای ما بنویسید.", 1, $now]);
