...
function seed_demo(PDO $pdo, $driver) {
    ...
    $settings = [
        'site_name' => 'پارچینو',
        'site_tagline' => 'فروش پارچه برای دوخت و دکور',
        'hero_title' => 'پارچه را ساده انتخاب کنید',
        'hero_subtitle' => 'پارچه‌های کاربردی و مجلسی را با قیمت هر متر ببینید، مقایسه کنید و سفارش بدهید.',
        'phone' => '',
        'mobile' => '09125085832',
        'email' => '',
